CREATE DEFINER=`admin`@`%` PROCEDURE `PostQuestions_SelectByCategoryGUID`(
...
WHERE q.CategoryGUID = pcategoryguid and q.RecordStatus = pquestionrecordstatus and a.RecordStatus = panswerrecordstatus
