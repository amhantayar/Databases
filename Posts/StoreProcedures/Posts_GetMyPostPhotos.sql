CREATE DEFINER=`admin`@`%` PROCEDURE `Posts_GetMyPostPhotos`(
IN userid char(37),IN pPage int, IN pCount int)
BEGIN
DECLARE startIndex  INT unsigned DEFAULT 0;  
	...
	create temporary table temp1
     ...
     from Posts  WHERE UserGUID = userid and FileType = 1;

select a.PostGUID,a.RecordStatus,a.Type, a.UserGUID, a.FileType, a.Images, 
